...
//TT2022
ConVar sk_plr_peacefulherb_heal("sk_plr_peacefulherb_heal", "25", FCVAR_REPLICATED);
#endif

//#ifdef TT2022
//ConVar sk_plr_healingherb_heal("sk_plr_sunnyd_heal", "25", FCVAR_REPLICATED);
//#endif
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		//TT2022
		def.AddAmmoType("Herb", DMG_BULLET, TRACER_NONE, NULL, NULL, "sk_max_herb", 0, 0);
